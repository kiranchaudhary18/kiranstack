      ...
      {!loading && !error && profile && (
        <>
          <motion.section
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="max-w-6xl mt-4 sm:mt-6 md:mt-8 lg:mt-10"
          >
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.08] via-sky-500/[0.06] to-emerald-500/[0.05] p-4 sm:p-6 shadow-[0_18px_60px_rgba(0,0,0,0.35)]">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 sm:gap-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  <img
                    ...
                    alt={profile.login}
                    className="w-16 sm:w-20 h-16 sm:h-20 rounded-full border border-white/20 object-cover shadow-[0_0_0_6px_rgba(255,255,255,0.04),0_18px_40px_rgba(0,0,0,0.35)]"
                  />
                  <div className="relative rounded-2xl bg-white/[0.06] border border-white/[0.12] px-3 sm:px-4 py-2 sm:py-3 backdrop-blur-md">
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                      <h3 className="text-xl sm:text-2xl lg:text-3xl font-poppins font-bold text-white">{profile.name || profile.login}</h3>
                      <p className="text-sm sm:text-base text-sky-200/90">@{profile.login}</p>
                    </div>
                    <p className="text-xs sm:text-sm text-gray-100/90 mt-1">{profile.bio || 'Full Stack Developer'}</p>
                    <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs text-gray-100/80 mt-2 sm:mt-3">
                      {profile.location && (
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-white/90 text-black font-semibold px-3 sm:px-5 py-2 sm:py-3 text-sm sm:text-base rounded-xl hover:bg-white transition-colors shadow-[0_16px_40px_rgba(0,0,0,0.25)]"
                >
          ...
          <motion.section
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="max-w-6xl mt-4 sm:mt-6 md:mt-8 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4"
          >
            <Card className="p-3 sm:p-4 md:p-5 border border-blue-400/20 bg-blue-500/5">
              <p className="text-gray-400 text-xs inline-flex items-center gap-1.5"><Users size={14} /> Followers</p>
              <p className="text-white text-2xl sm:text-3xl lg:text-4xl font-poppins font-bold mt-1.5 sm:mt-2">{profile.followers}</p>
            </Card>
            <Card className="p-3 sm:p-4 md:p-5 border border-cyan-400/20 bg-cyan-500/5">
              <p className="text-gray-400 text-xs inline-flex items-center gap-1.5"><UserPlus size={14} /> Following</p>
              <p className="text-white text-2xl sm:text-3xl lg:text-4xl font-poppins font-bold mt-1.5 sm:mt-2">{profile.following}</p>
            </Card>
            <Card className="p-3 sm:p-4 md:p-5 border border-violet-400/20 bg-violet-500/5">
              <p className="text-gray-400 text-xs inline-flex items-center gap-1.5"><BookOpen size={14} /> Public Repos</p>
              <p className="text-white text-2xl sm:text-3xl lg:text-4xl font-poppins font-bold mt-1.5 sm:mt-2">{profile.public_repos}</p>
            </Card>
            <Card className="p-3 sm:p-4 md:p-5 border border-emerald-400/20 bg-emerald-500/5">
              <p className="text-gray-400 text-xs inline-flex items-center gap-1.5"><Github size={14} /> Public Gists</p>
              <p className="text-white text-2xl sm:text-3xl lg:text-4xl font-poppins font-bold mt-1.5 sm:mt-2">{profile.public_gists}</p>
            </Card>
          </motion.section>
          ...
          <motion.section
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="max-w-6xl mt-4 sm:mt-6 md:mt-8"
          >
            <Card className="p-4 sm:p-5">
              ...
              <div className="flex flex-wrap gap-2 mb-4 sm:mb-5">
                <span className="px-2 sm:px-3 py-1 rounded-full text-xs bg-white/10 text-gray-100 border border-white/10">User</span>
                <span className="px-2 sm:px-3 py-1 rounded-full text-xs bg-green-500/20 text-green-300 border border-green-500/30">Active</span>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
                <div className="rounded-xl border border-white/10 p-3 sm:p-4 bg-dark-900/40">
                  <p className="text-gray-400 text-xs sm:text-sm">Active Repos</p>
                  <p className="text-emerald-300 text-2xl sm:text-3xl font-poppins font-bold mt-1">{repoStats.active}</p>
                </div>
                <div className="rounded-xl border border-white/10 p-3 sm:p-4 bg-dark-900/40">
                  <p className="text-gray-400 text-xs sm:text-sm">Forked Repos</p>
                  <p className="text-secondary text-2xl sm:text-3xl font-poppins font-bold mt-1">{repoStats.forked}</p>
                </div>
                <div className="rounded-xl border border-white/10 p-3 sm:p-4 bg-dark-900/40">
                  <p className="text-gray-400 text-xs sm:text-sm">Issues Enabled</p>
                  <p className="text-violet-300 text-2xl sm:text-3xl font-poppins font-bold mt-1">{repoStats.issuesEnabled}</p>
                </div>
                <div className="rounded-xl border border-white/10 p-3 sm:p-4 bg-dark-900/40">
                  <p className="text-gray-400 text-xs sm:text-sm">Pages Enabled</p>
                  <p className="text-secondary text-2xl sm:text-3xl font-poppins font-bold mt-1">{repoStats.pagesEnabled}</p>
                </div>
              </div>
            </Card>
          </motion.section>
          ...
          <motion.section
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="max-w-6xl mt-6 sm:mt-8 md:mt-10"
          >
            <div className="mb-3 sm:mb-4">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-poppins font-bold text-accent drop-shadow-[0_0_14px_rgba(212,175,55,0.18)]">
                Repositories
              </h3>
              <p className="text-xs sm:text-sm text-gray-400">Showing top {repos.length} public repositories with descriptions.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5">
              {repos.map((repo) => (
                <a
                  ...
                  className="block"
                >
                  <Card className="p-4 sm:p-5 h-full flex flex-col cursor-pointer">
                  <div className="flex items-start justify-between gap-2 sm:gap-3">
                    <h4 className="text-base sm:text-xl font-bold text-gray-100 leading-tight group-hover:text-accent transition-colors">{repo.name}</h4>
                    <span className="text-gray-400 hover:text-accent transition-colors flex-shrink-0">
                      <ExternalLink size={16} />
                    </span>
                  </div>
                  <p className="text-gray-400 text-xs sm:text-sm mt-2 sm:mt-3 min-h-[40px]">{repo.description || 'No description provided.'}</p>
                  ...
                  <div className="mt-3 sm:mt-5 pt-3 sm:pt-4 border-t border-white/10 text-xs sm:text-sm text-gray-400 flex items-center gap-3 sm:gap-4 flex-wrap">
